...
class Alerts {
    ...
    static func showPanelActionsheet(viewController: UIViewController, title: String?, message: String?, actions: [(String, UIAlertAction.Style, KREAction?)], panels: KREPanelItem?, widget: KREWidget?, completion: @escaping (_ index: Int, _ action: KREAction?) -> Void) {
