...
class CardTemplateListCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code Bundle.xib(named: listCellIdentifier)
        self.collV.register(Bundle.xib(named: "CardTemplateCollectionVCell"), forCellWithReuseIdentifier: "CardTemplateCollectionVCell")
    }
