...
class AudioNewBubbleView: BubbleView {
    ...
    private func layoutConstraints() {
        NSLayoutConstraint.activate([
            ...
            audioView.topAnchor.constraint(equalTo: titleLbl.bottomAnchor, constant: 10),
    ...
    override func populateComponents() {
        ...
        if titleStr.isEmpty {
            ...
            audioView.topAnchor.constraint(equalTo: cardView.topAnchor, constant: 10).isActive = true
        } else {
            titleLbl.isHidden = false
            audioView.topAnchor.constraint(equalTo: titleLbl.bottomAnchor, constant: 10).isActive = true
        }
