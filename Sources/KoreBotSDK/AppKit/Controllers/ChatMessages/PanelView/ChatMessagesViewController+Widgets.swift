...
class KREWidgetViewControllerDelegate: NSObject, KREGenericWidgetViewDelegate {
    ...
    func widgetActionUi(component: Any) {
        ...
        Alerts.showPanelActionsheet(viewController: viewController, title: title, message: "", actions: actions, panels: nil, widget: nil) { [weak self] (index, action) in
    ...
    func widgetActionUiForCommonWidget(component: Any, panel: KREPanelItem?, widget: KREWidget?) {
        ...
        Alerts.showPanelActionsheet(viewController: navigationController, title: title, message: "", actions: actions, panels: panel, widget: widget) { [weak self] (index, action)  in
            if index == actionString.count {
                print("Cancel")
            } else {
    ...
    func populateActions(_ actions: [KREAction]?, in widget: KREWidget?, in panel: KREPanelItem?) {
        ...
        Alerts.showPanelActionsheet(viewController: navigationController, title: nil, message: nil, actions: alertActions, panels: panel, widget: widget) { [weak self] (index, action)  in
