...
var BubbleViewRightTint: UIColor = themeHighlightColor
    ...
    static func bubbleWithType(_ bubbleType: ComponentType) -> BubbleView{
        ...
        switch (bubbleType) {
            case .text:
                ...
                break
            case .image, .video:
                //bubbleView = Bundle.module.loadNibNamed("MultiImageBubbleView", owner: self, options: nil)![0] as? BubbleView
            bubbleView = Bundle.module.loadNibNamed("MultiImageBubbleView", owner: self, options: nil)![0] as? BubbleView
                break
            case .audio:
                //bubbleView = Bundle.module.loadNibNamed("AudioBubbleView", owner: self, options: nil)![0] as? BubbleView
                bubbleView = Bundle.module.loadNibNamed("AudioBubbleView", owner: self, options: nil)![0] as? BubbleView
                break
            case .options:
