...
class AdvanceListBubbleView: BubbleView {
    let frameworkBundle = KREResourceLoader.shared.resourceBundle()
    var tileBgv: UIView!
    ...
    override func initialize() {
        ...
        self.tableView.register(UINib(nibName: AdvancedListOptionsCellIdentifier, bundle: frameworkBundle), forCellReuseIdentifier: AdvancedListOptionsCellIdentifier)
        self.tableView.register(UINib(nibName: AdvancedListDefaultCellIdentifier, bundle: frameworkBundle), forCellReuseIdentifier: AdvancedListDefaultCellIdentifier)
        self.tableView.register(UINib(nibName: AdvanceListGridCellIdentifier, bundle: frameworkBundle), forCellReuseIdentifier: AdvanceListGridCellIdentifier)
        self.tableView.register(UINib(nibName: AdvancedListButtonCellIdentifier, bundle: frameworkBundle), forCellReuseIdentifier: AdvancedListButtonCellIdentifier)
...
//        tableView.clipsToBounds = true
    ...
    func intializeHeaderViewLayout(){
        ...
        headerTitle.font = UIFont(name: "HelveticaNeue-Medium", size: 16.0)
        ...
        headerDesc.font = UIFont(name: "HelveticaNeue-Medium", size: 12.0)
        ...
        sortBtn.setImage(UIImage(named: "sort", in: frameworkBundle, compatibleWith: nil), for: .normal)
        ...
        sortBtn.titleLabel?.font = UIFont(name: "HelveticaNeue-Medium", size: 15.0)
...
extension AdvanceListBubbleView: UITableViewDelegate, UITableViewDataSource{
        ...
        if let optionsView = elementDetails.view, optionsView == "options"{
            ...
            if optionsDataDetails?.type == "checkbox"{
                if checkboxIndexPath.contains(indexPath) {
                    let radio_check = UIImage(named: "check", in: frameworkBundle, compatibleWith: nil)
                    ...
                    let radio_check = UIImage(named: "uncheck", in: frameworkBundle, compatibleWith: nil)
                    let tintedradio_checkImage = radio_check?.withRenderingMode(.alwaysTemplate)
                    cell.checkBtn.setImage(tintedradio_checkImage, for: .normal)
                ...
                if checkboxIndexPath.contains(indexPath) {
                    let radio_check = UIImage(named: "radio_check", in: frameworkBundle, compatibleWith: nil)
                    let tintedradio_checkImage = radio_check?.withRenderingMode(.alwaysTemplate)
                    cell.checkBtn.setImage(tintedradio_checkImage, for: .normal)
                    cell.checkBtn.tintColor = .blue
                }else{
                    let radio_check = UIImage(named: "radio_uncheck", in: frameworkBundle, compatibleWith: nil)
                    let tintedradio_checkImage = radio_check?.withRenderingMode(.alwaysTemplate)
                    cell.checkBtn.setImage(tintedradio_checkImage, for: .normal)
                    cell.checkBtn.tintColor = .lightGray
                }
            ...
            if let headerOptions = elementDetails.headerOptions, headerOptions.count > 0{
                ...
                if let optionsType = options.type, optionsType == "dropdown"{
                    ...
                    let imgV = UIImage.init(named: "VDotMenu", in: frameworkBundle, compatibleWith: nil)
            ...
            if let isCollapsed = elementDetails.isCollapsed, isCollapsed == true{
                cell.arrowImgwidthConstraint.constant = 15.0
                let imgV = UIImage.init(named: "downarrow", in: frameworkBundle, compatibleWith: nil)
                cell.arrowImag.image = imgV?.withRenderingMode(.alwaysTemplate)
                cell.arrowImag.tintColor = .black
            }
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        if optionsView == "options"{
            ...
            let bundle = Bundle(for: AdvanceListBubbleView.self)
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        //}
//        if let isCollapsed = headerDetails.isCollapsed, isCollapsed == true{
//            headerView.dropDownBtnWidthConstraint.constant = 15.0
//            let imgV = UIImage.init(named: "downarrow", in: frameworkBundle, compatibleWith: nil)
//            let tintedMenuImage = imgV?.withRenderingMode(.alwaysTemplate)
//            headerView.dropDownBtn.setImage(tintedMenuImage, for: .normal)
                ...
                if displayLimit < elementDetails.buttons?.count ?? 0{
                    if displayLimit == indexPath.item{
                        ...
                        if #available(iOS 13.0, *) {
                            cell.titleBtn.setImage(UIImage(named: "DotMenu", in: frameworkBundle, with: nil), for: .normal)
                        } else {
...
//                cell.titleBtn.tag = indexPath.item
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        var textWidth = 10
        let size = text?.size(withAttributes:[.font: UIFont(name: "HelveticaNeue-Medium", size: 14.0) as Any])
        if text != nil {
