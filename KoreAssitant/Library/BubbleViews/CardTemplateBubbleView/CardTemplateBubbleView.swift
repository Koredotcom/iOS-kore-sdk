...
class CardTemplateBubbleView: BubbleView {
    ...
    override func initialize() {
        ...
        self.tableView.register(UINib(nibName: gridListCellIdentifier, bundle: frameworkBundle), forCellReuseIdentifier: gridListCellIdentifier)
...
extension CardTemplateBubbleView: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        footerBtn.titleLabel?.font = UIFont(name: "HelveticaNeue-Medium", size: 15.0)
