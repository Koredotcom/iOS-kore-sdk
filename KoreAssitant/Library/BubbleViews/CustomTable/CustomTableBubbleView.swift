...
class CustomTableBubbleView: BubbleView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func initialize() {
        ...
        self.collectionView.register(UINib(nibName: "CustomTableViewCell", bundle: bundle),
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if(data.headers.count<5){
            ...
            let width : CGFloat = (header.title as NSString).size(withAttributes: [NSAttributedString.Key.font : UIFont(name: "HelveticaNeue-Bold", size: 14.0) as Any]).width*2.0
            itemWidth = width
        }
