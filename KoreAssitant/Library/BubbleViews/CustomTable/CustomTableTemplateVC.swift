...
class CustomTableTemplateVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UITableViewDelegate, UITableViewDataSource {
    ...
    init(dataString: String) {
        super.init(nibName: "CustomTableTemplateVC", bundle: bundle)
    ...
    override func viewDidLoad() {
        ...
        if(self.data.tableDesign == "regular"){
            ...
            self.collectionView.register(UINib(nibName: "CustomTableViewCell", bundle: bundle), forCellWithReuseIdentifier: customCellIdentifier)
...
//        }
//        else{
            let width : CGFloat = (header.title as NSString).size(withAttributes: [NSAttributedString.Key.font : UIFont(name: "HelveticaNeue-Bold", size: 14.0) as Any]).width
