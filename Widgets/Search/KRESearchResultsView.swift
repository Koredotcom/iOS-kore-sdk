...
public class KRESearchResultsView: UIView {
    // MARK: - properties
    let bundle = Bundle(for: KRESearchResultsView.self)
...
public class KRESearchResultHeaderView: UITableViewHeaderFooterView {
    // MARK: - properties
    let bundle = Bundle(for: KRESearchResultHeaderView.self)
...
public class KRESearchResultFooterView: UITableViewHeaderFooterView {
    // MARK: - properties
    let bundle = Bundle(for: KRESearchResultFooterView.self)
