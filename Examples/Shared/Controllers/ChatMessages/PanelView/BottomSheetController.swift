...
public class BottomSheetController: KABasePanelViewController {
    ...
    public var willSheetSizeChange: ((BottomSheetController, SheetSize) -> Void)?
    public var willDismiss: ((BottomSheetController) -> Void)?
    ...
    public override func viewDidLoad() {
        ...
        colorView.backgroundColor = UIColor.init(alpha: 0.6, red: 20, green: 20, blue: 20)
