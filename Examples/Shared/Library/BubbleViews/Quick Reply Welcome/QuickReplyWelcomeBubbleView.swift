...
class QuickReplyWelcomeBubbleView: BubbleView {
    ...
    override func initialize() {
        ...
        let bundle = Bundle(for: QuickReplyWelcomeBubbleView.self)
...
extension QuickReplyWelcomeBubbleView : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        var textWidth = 10
        let size = text?.size(withAttributes:[.font: UIFont(name: "HelveticaNeue-Medium", size: 12.0) as Any])
        if text != nil {
