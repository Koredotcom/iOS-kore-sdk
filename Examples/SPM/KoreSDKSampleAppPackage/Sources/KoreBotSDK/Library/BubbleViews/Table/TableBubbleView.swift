...
class TableBubbleView: BubbleView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func initialize() {
        ...
        self.showMoreButton.setTitleColor(themeHighlightColor, for: .normal)
        self.showMoreButton.titleLabel?.font = UIFont(name: "HelveticaNeue-Bold", size: 12.0)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section == 0 {
            ...
            cell.textLabel.font = UIFont(name: "HelveticaNeue-Bold", size: 10.0)
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if(data.headers.count<5){
            ...
            let width : CGFloat = (header.title as NSString).size(withAttributes: [NSAttributedString.Key.font : UIFont(name: "HelveticaNeue-Bold", size: 10.0) as Any]).width //*2.0
//            if width > 85.0{
                itemWidth = 85.0
//            }else{
//                itemWidth = width
