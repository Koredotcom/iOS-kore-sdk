...
class ComposeBarView: UIView {
    ...
    fileprivate func setupViews() {
        //self.backgroundColor = UIColor.init(hexString: (brandingShared.brandingInfoModel?.widgetFooterColor) ?? "#eaeaea")
        ...
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[bottomLineView(0.5)]|", options:[], metrics:nil, views:views))
         ...
         self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-10-[menuButton(0)]-5-[growingTextView]-5-[sendButton(30)]-5-[attachmentButton(25)]-10-|", options:[], metrics:nil, views:views))
