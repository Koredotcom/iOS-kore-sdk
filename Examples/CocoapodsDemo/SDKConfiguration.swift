...
public class SDKConfiguration: NSObject {
   ...
   public struct botConfig {
      ...
      public static var tenantId = "<12343453453>"

      public static var identity = "<identity-email> or <random-id>"//"sainath.bhima@kore.com"// This should represent the subject for JWT token. This can be an email or phone number, in case of known user, and in case of anonymous user, this can be a randomly generated unique id.
   ...
   public struct serverConfig {
       public static let JWT_SERVER = String(format: "http://<jwt-server-host>/") // Replace it with the actual JWT server URL, if required. Refer to developer documentation for instructions on hosting JWT Server.

       public static func koreJwtUrl() -> String {
            return String(format: "%@users/sts", JWT_SERVER)
        }

      public  static var BOT_SERVER = String(format: "https://bots.kore.ai/api")
