...
//
//    struct botConfig {
//        static let clientId = "cs-854a9d4d-9f34-5fdb-a5e3-6fa864ed77c8" // Copy this value from Bot Builder SDK Settings ex. cs-5250bdc9-6bfe-5ece-92c9-ab54aa2d4285
//
//        static let clientSecret = "knoJVXBrxflCUczrwFYkTp2FK476oZneN7cb7Mqdxxc=" // Copy this value from Bot Builder SDK Settings ex. Wibn3ULagYyq0J10LCndswYycHGLuIWbwHvTRSfLwhs=
//
//        static let botId =  "st-5840c71a-ec0b-516e-8d9a-f9e608ea8c4b" // Copy this value from Bot Builder -> Channels -> Web/Mobile Client  ex. st-acecd91f-b009-5f3f-9c15-7249186d827d
//
//        static let chatBotName = "WebhookRajBot" // Copy this value from Bot Builder -> Channels -> Web/Mobile Client  ex. "Demo Bot"
//
//        static let identity = "rajasekhar.balla12345@kore.com"// This should represent the subject for JWT token. This can be an email or phone number, in case of known user, and in case of anonymous user, this can be a randomly generated unique id.
//
...
//        }
//
//        static let BOT_SERVER = String(format: "https://qa-bots.kore.ai")
