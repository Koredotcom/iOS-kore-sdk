...
class SDKConfiguration: NSObject {
    ...
    struct serverConfig {
        ...
        public static let KORE_SERVER = String(format: "https://qa1-bots.kore.ai/")
    }
   
    struct widgetConfig {
        static let clientId = "cs-d9e501a4-633e-59e0-8660-ceb32cec9a4c" // Copy this value from Bot Builder SDK Settings ex. cs-5250bdc9-6bfe-5ece-92c9-ab54aa2d4285
        
        static let clientSecret = "3ez7zBmwlt9F5V5Nh5oi8Y7oDdjxCzYZ78DFqgX/Kvo=" // Copy this value from Bot Builder SDK Settings ex. Wibn3ULagYyq0J10LCndswYycHGLuIWbwHvTRSfLwhs=
        
        static let botId =  "st-5baee3ee-0254-5f9b-8f13-f06da3a0fc5c" // Copy this value from Bot Builder -> Channels -> Web/Mobile Client  ex. st-acecd91f-b009-5f3f-9c15-7249186d827d

        static let chatBotName = "SDK_WIDGET_MAIN" // Copy this value from Bot Builder -> Channels -> Web/Mobile Client  ex. "Demo Bot"
        
        static let identity = "sri.harsha@kore.com"// This should represent the subject for JWT token. This can be an email or phone number, in case of known user, and in case of anonymous user, this can be a randomly generated unique id.
