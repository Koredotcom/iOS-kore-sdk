...
//        self.headingLabel.linkTextColor = Common.UIColorRGB(0x0076FF)
        self.headingLabel.font = UIFont(name: "Gilroy-Regular", size: 16.0)
...
//        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-10-[tableView]-10-|", options: [], metrics: nil, views: views))
        ...
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-16-[headingLabel(>=15)]-16-|", options: [], metrics: nil, views: views))
...
//                }
    ...
    override var intrinsicContentSize : CGSize {
       // let limitingSize: CGSize  = CGSize(width: BubbleViewMaxWidth - 20, height: CGFloat.greatestFiniteMagnitude)
        ...
        return CGSize(width: BubbleViewMaxWidth-60, height: 32+20) //headingLabelSize.height + 10
...
extension InLineFormBubbleView: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let attributes: [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: UIFont(name: "Gilroy-Medium", size: 14.0)!, NSAttributedString.Key.foregroundColor: UIColor.darkGray]
