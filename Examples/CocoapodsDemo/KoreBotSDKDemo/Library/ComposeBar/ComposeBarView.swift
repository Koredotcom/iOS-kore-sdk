...
class ComposeBarView: UIView {
    ...
    fileprivate func setupViews() {
        ...
        let attributes: [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: UIFont(name: "Gilroy-Regular", size: 15.0)!, NSAttributedString.Key.foregroundColor: UIColor.init(hexString: (brandingShared.brandingInfoModel?.userchatBgColor)!)]
        ...
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-15-[menuButton(30)]-10-[growingTextView]-10-[sendButton]-15-[speechToTextButton]-15-|", options:[], metrics:nil, views:views))
        ...
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|->=3-[sendButton]-8-|", options:[], metrics:nil, views:views))
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|->=3-[menuButton]-8-|", options:[], metrics:nil, views:views))
