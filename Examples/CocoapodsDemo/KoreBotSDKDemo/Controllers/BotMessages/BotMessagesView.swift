...
//                bubbleView.maskview.isHidden = true //hide
//                isReloadTabV = true
//            }else{
//                bubbleView.maskview.isHidden = false //show
//            }
        ...
        case .newList:
           ...
           // let secondIndexPath:NSIndexPath = NSIndexPath.init(row: 1, section: 0)
            if firstIndexPath.isEqual(indexPath)  { //|| secondIndexPath.isEqual(indexPath)
                ...
                //bubbleView.tableView.isUserInteractionEnabled = false
            }
            break
        case .tableList:
...
//        return label
        ...
        imageV.image = UIImage.init(named: "Loan", in: frameworkBundle, compatibleWith: nil)
