...
//        let Branding_SERVER = String(format: "https://bots.kore.ai")
        ...
        let clientId = "cs-d098fa1a-e2c9-5597-92c7-26429a7734ab" // Copy this value from Bot Builder SDK Settings ex. cs-5250bdc9-6bfe-5ece-92c9-ab54aa2d4285
        let clientSecret = "Vt3n10gq1pCI4TmUmdfZGxfosqnTlsTiXtsKyuxWGl4=" // Copy this value from Bot Builder SDK Settings ex. Wibn3ULagYyq0J10LCndswYycHGLuIWbwHvTRSfLwhs=
        let botId =  "st-a3143235-3ae0-5abe-96be-1f3be748ec16" // Copy this value from Bot Builder -> Channels -> Web/Mobile Client  ex. st-acecd91f-b009-5f3f-9c15-7249186d827d
        let chatBotName = "Zen Banking Bot" // Copy this value from Bot Builder -> Channels -> Web/Mobile Client  ex. "Demo Bot"
