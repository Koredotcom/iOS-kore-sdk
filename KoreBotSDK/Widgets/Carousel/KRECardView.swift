...
public class KRECardView: UIView, UIGestureRecognizerDelegate {
    ...
    static let kButtonHeight: CGFloat = 40
    static let kButtonSpacing: CGFloat = 2
    static let kMaxRowHeight: CGFloat = kButtonHeight + kButtonSpacing
    ...
    public func setup() {
        ...
        optionsView.buttonSpacing = KRECardView.kButtonSpacing
        optionsView.buttonRowHeight = KRECardView.kMaxRowHeight
