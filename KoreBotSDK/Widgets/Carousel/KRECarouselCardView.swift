...
public class KRECarouselCardView: UIView, UIGestureRecognizerDelegate {
    ...
    static let kMaxRowHeight: CGFloat = KRECardView.kMaxRowHeight
    ...
    public func setup() {
        ...
        self.optionsView.buttonSpacing = KRECardView.kButtonSpacing
        self.optionsView.buttonRowHeight = KRECardView.kMaxRowHeight
