...
- (instancetype)init {
    ...
    if(self) {
        ...
        NSBundle* bundle = [NSBundle bundleForClass:[KRETypingStatusView class]];
        [self.collectionView registerNib:[UINib nibWithNibName:@"KRETypingCollectionViewCell" bundle:bundle] forCellWithReuseIdentifier:@"TypingCell"];
