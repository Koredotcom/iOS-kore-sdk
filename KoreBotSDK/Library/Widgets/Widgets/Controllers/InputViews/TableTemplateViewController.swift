...
class TableTemplateViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UITableViewDelegate, UITableViewDataSource {
    ...
    init(dataString: String) {
        super.init(nibName: "TableTemplateViewController", bundle: Bundle(for: TableTemplateViewController.self))
    ...
    override func viewDidLoad() {
        ...
        if(self.data.tableDesign == "regular"){
            ...
            self.collectionView.register(UINib(nibName: "CustomCollectionViewCell", bundle: Bundle(for: TableTemplateViewController.self)), forCellWithReuseIdentifier: customCellIdentifier)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.textLabel.textColor = UIColorRGB(0x26344A)
