...
open class CoreDataManager: NSObject {
    ...
    private lazy var managedObjectModel: NSManagedObjectModel = {
        if let modelURL = Bundle(for: CoreDataManager.self).url(forResource: "DataModel", withExtension: "momd"), let managedObjectModel = NSManagedObjectModel(contentsOf: modelURL) {
