    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPaths.count>0 {
            if indexPaths.contains(indexPath){
                ...
                subtableViewCell.accessoryView = UIImageView(image: UIImage(named: "arrowSelected", in: Bundle(for: self.classForCoder), compatibleWith: nil))
                ...
                cell.accessoryView = UIImageView(image: UIImage(named: "arrowUnselected", in: Bundle(for: self.classForCoder), compatibleWith: nil))
