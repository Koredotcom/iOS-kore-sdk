...
class BubbleView: UIView {
    ...
    var leftBubbleBorderColor: UIColor = KoreBotUIKit.Bot.BubbleView.backgroundColor
    var rightBubbleBorderColor: UIColor = KoreBotUIKit.User.BubbleView.backgroundColor
    var leftBubbleViewContrastTint = UIColorRGB(0xBCBCBC)
    var rightBubbleViewContrastTint = UIColorRGB(0xFFFFFF)

    var components: [KREComponent]? {
        didSet(c) {
    ...
    func contrastTintColor() -> UIColor {
        if (self.tailPosition == BubbleMaskTailPosition.left) {
            return leftBubbleViewContrastTint
        }
        
        return rightBubbleViewContrastTint
    }
    
    func borderColor() -> UIColor {
        if (self.tailPosition == BubbleMaskTailPosition.left) {
            return leftBubbleBorderColor
        }
        
        return rightBubbleBorderColor
    }
    ...
    func applyBubbleMask() {
        ...
        if (self.drawBorder) {
            ...
            self.borderLayer.strokeColor = UIColorRGB(0xebebeb).cgColor
