...
open class AudioComposeView: UIView {
    ...
    public var checkAudioRecordingPermissions: ((_ composeView: AudioComposeView?, _ block:((Bool) -> Void)?) -> Void)?
    ...
    fileprivate func setupViews() {
        ...
        if let image = UIImage(named: "audio_icon", in: Bundle(for: self.classForCoder), compatibleWith: nil) {
        ...
        self.keyboardButton.setImage(UIImage(named: "keyboard", in: Bundle(for: self.classForCoder), compatibleWith: nil), for: .normal)
