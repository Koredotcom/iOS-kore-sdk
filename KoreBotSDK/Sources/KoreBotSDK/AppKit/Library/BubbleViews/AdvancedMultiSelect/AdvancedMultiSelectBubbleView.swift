    ...
    */
    ...
    override func initialize() {
       ...
       // UserDefaults.standard.set(false, forKey: "SliderKey")
        ...
        self.cardView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-5-[tileBgv]-5-[tableView]-5-|", options: [], metrics: nil, views: views))
...
extension AdvancedMultiSelectBubbleView: UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headerSubView.descLbl.textColor = .lightGray
