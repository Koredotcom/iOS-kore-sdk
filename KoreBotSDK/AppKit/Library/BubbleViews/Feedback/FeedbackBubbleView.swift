...
class FeedbackBubbleView: BubbleView {
    ...
    override func initialize() {
       ...
       // UserDefaults.standard.set(false, forKey: "SliderKey")
        ...
        let starFull = UIImage(named: "StarFull", in: bundle, compatibleWith: nil)
        floatRatingView.fullImage = starFull?.withTintColor(BubbleViewRightTint, renderingMode: .alwaysOriginal)
