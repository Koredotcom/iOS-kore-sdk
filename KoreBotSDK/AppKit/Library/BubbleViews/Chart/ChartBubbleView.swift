...
class ChartBubbleView: BubbleView, AxisValueFormatter, ValueFormatter {
   ...
   // public var optionsAction: ((_ text: String?) -> Void)!
    ...
    func colorsPalet() -> [NSUIColor]{
        ...
        let bubbleRBg = BubbleViewRightTint
        colors.append(bubbleRBg)
        let alphas: [CGFloat] = [0.6, 0.2, 0.8, 0.4, 0.7, 0.5, 0.35, 0.45, 0.25, 0.3]
        for alpha in alphas {
            colors.append(bubbleRBg.withAlphaComponent(alpha))
        }
