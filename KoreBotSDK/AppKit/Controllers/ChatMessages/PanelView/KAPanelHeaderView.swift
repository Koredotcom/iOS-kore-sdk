...
public class KAPanelHeaderView: UIView {
    ...
    public lazy var iconImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "tasksPanel", in: bundle, compatibleWith: nil)
    ...
    public lazy var closeButton: UIButton = {
        ...
        button.setImage(UIImage(named: "panelHeaderClose", in: bundle, compatibleWith: nil), for: .normal)
    ...
    public lazy var reoderButton: UIButton = {
        let button = UIButton(frame: .zero)
        button.setImage(UIImage(named: "reorder", in: bundle, compatibleWith: nil), for: .normal) 
        button.imageView?.contentMode = .scaleAspectFit
        button.translatesAutoresizingMaskIntoConstraints = false
        return button
    }()
