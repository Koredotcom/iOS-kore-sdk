...
class ServerConfigs: NSObject {
    ...
    open static let BOT_SPEECH_WEBSOCKET = String(format: "<speech-server-socket-url>") //Example wss://speech.kore.ai/speechcontext/bot? > please provide socket url with '?' in end
}
