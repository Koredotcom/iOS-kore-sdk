...
class ServerConfigs: NSObject {
    ...
    open static let BOT_SPEECH_SERVER = String(format: "<speech-server-url>") //Can take both http and wss urls, If providing websocket url Example wss://speech.kore.ai/speechcontext/bot? > please provide socket url with '?' in end
}
